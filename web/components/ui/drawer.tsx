...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex flex-col border bg-white shadow-2xl",
      ...
      {...props}
    >
      <div className="data-[vaul-drawer-direction=bottom]:mx-auto data-[vaul-drawer-direction=bottom]:mt-4 data-[vaul-drawer-direction=bottom]:h-2 data-[vaul-drawer-direction=bottom]:w-[100px] data-[vaul-drawer-direction=bottom]:rounded-full data-[vaul-drawer-direction=bottom]:bg-muted" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
