        ...
        >
          ...
          <div className="px-6 py-4">
            <p className="text-sm text-gray-600">
              Are you sure you want to delete the data attribute{' '}
            ...
            <div className="mt-3 p-3 bg-red-50 rounded-lg border border-red-100">
              <p className="text-xs text-red-700">
                <strong>Warning:</strong> After deletion, entities associated with this attribute may be marked as orphaned. This action cannot be undone.
              </p>
            </div>
          </div>
